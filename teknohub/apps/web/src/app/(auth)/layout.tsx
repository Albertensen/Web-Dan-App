...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="flex-1 flex flex-col lg:flex-row min-h-[calc(100vh-10rem)]">
      ...
      <aside className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-to-br from-accent via-[#16285e] to-[#0b1f45] p-12 text-white relative overflow-hidden">
