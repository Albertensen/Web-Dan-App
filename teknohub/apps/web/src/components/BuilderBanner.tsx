...
export default function BuilderBanner() {
  return (
    <section>
      <Link
        href="/builder"
        className="block group relative bg-gradient-to-br from-[#0F2A4A] via-[#16335C] to-[#1E3A8A] text-white rounded-3xl p-8 md:p-14 overflow-hidden shadow-xl hover:shadow-2xl transition duration-300"
      >
        {/* Decorative glow */}
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <p className="text-[#CBD5E1] text-xs md:text-sm leading-relaxed mb-7 max-w-md">
            Simulasi perakitan 3D interaktif. AI mengecek kompatibilitas komponen dan
            mencegah bottleneck secara real-time.
          </p>
          <span className="inline-flex items-center gap-2 bg-white text-[#0F2A4A] font-extrabold hover:bg-slate-100 text-xs px-6 py-3.5 rounded-full shadow-lg group-hover:gap-3 transition-all">
