...
export default function PCBuilderChatInterface() {
  ...
  return (
    <div className="relative border border-slate-300 rounded-xl bg-surface-2 overflow-hidden">
      ...
      {/* Toast notif */}
      {toast && (
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-full bg-emerald-700 text-white text-xs font-semibold shadow-lg animate-fade-in-up">
          {toast}
        </div>
      )}
    </div>
